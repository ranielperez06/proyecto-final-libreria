-- Base de datos lista para importar en phpMyAdmin o MySQL.
-- Incluye la base original entregada por el docente y la tabla contacto
-- solicitada para el formulario del portal.
...
-- Se incluye una sola columna correo; la duplicación de "correo" en el
-- documento de requisitos es un error tipográfico.
--
